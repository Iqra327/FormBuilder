  ...
  useDndMonitor({
    onDragEnd: (event: DragEndEvent) =>{
      ...
      if (droppingSidebarBtnOverDesignerDropArea){
        // I'm dropping a SidebarElement over the drop-zone-area
        const type = active.data?.current?.type;
        const newElement = FormElements[type as ElementsType].construct(
          idGenerator()
        );

        {/*i changed 0 to elements.length because with 0 it was placing new field at the top, now it places below the previous field */}
